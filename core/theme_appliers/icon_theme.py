...
Two independent mechanisms live here:
  ...
  - icon_accent: restored from a pre-baked symlink snapshot in
    assets/icon-themes/ (see scripts/bake_icon_accents.py), rather than
...
ASSETS_DIR = Path(__file__).resolve().parent.parent.parent / "assets" / "icon-themes"
